 ...
 */
const getNearestSample = (samples, note, octave) => {
    let sampleBank = samples.map((sample) => {
        let s = sample.sampleName.slice(0, sample.sampleName.length - 4);
